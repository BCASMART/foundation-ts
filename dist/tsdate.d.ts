...
export declare function $secondFromTimestamp(ts: number): uint;
export declare function $minuteFromTimestamp(ts: number): uint;
export declare function $hourFromTimestamp(ts: number): uint;
export declare function $timestampWithoutTime(ts: number): number;
export declare function $dayOfYear(ts: number): number;
export declare function $dayOfWeekFromTimestamp(ts: number, offset?: number): number;
